...
const Register = () => {
  ...
  return (
    <Layout>
      ...
      <div className="py-32">
        <div className="w-1/2 rounded-lg shadow dark:bg-black p-8 border border-gray-200 dark:border-gray-100 mx-auto">
          <div className="mb-10">
            <h1 className="text-2xl dark:text-white font-semibold">Register</h1>
            <h3 className="text-sm text-gray-500 dark:text-gray-300">Register your account now to get full access</h3>
          </div>
          <form onSubmit={handleSubmit(handleRegister)}>
            ...
            <input
              type="text"
              className={`w-full text-sm p-3 rounded-md dark:bg-gray-900 dark:text-white border border-gray-300 focus:outline outline-offset-2 outline-2 mt-2 ${!errors.full_name && "mb-8"}`}
            ...
            <label htmlFor="role" className="text-sm dark:text-white font-semibold">
              Role
            </label>
            <br />
            <select
            ...
            <label htmlFor="retype_password" className="text-sm dark:text-white font-semibold">
              Password Retype
            </label>
            <br />
            <input
              type="password"
              className={`w-full text-sm p-3 rounded-md dark:bg-gray-900 dark:text-white border border-gray-300 focus:outline outline-offset-2 outline-2 mt-2 ${!errors.retype_password && "mb-8"}`}
            ...
            <input
              type="text"
              className={`w-full text-sm p-3 rounded-md dark:bg-gray-900 dark:text-white border border-gray-300 focus:outline outline-offset-2 outline-2 mt-2 ${!errors.address && "mb-8"}`}
              placeholder="Address"
              {...register("address")}
              disabled={isSubmitting}
              aria-disabled={isSubmitting}
            ...
            <input
              type="string"
              className={`w-full text-sm p-3 rounded-md dark:bg-gray-900 dark:text-white border border-gray-300 focus:outline outline-offset-2 outline-2 mt-2 ${!errors.phone_number && "mb-8"}`}
            ...
            <div className="flex flex-col items-center">
              ...
              <Link to={"/login"} className="bg-gray-200 hover:bg-black/90 dark:hover:bg-gray-900 hover:text-white text-center text-black text-sm text-semibold p-3 rounded-md w-11/12">
                Login
              </Link>
            </div>
          </form>
